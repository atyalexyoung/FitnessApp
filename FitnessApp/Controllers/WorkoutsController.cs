...
namespace FitnessApp.Controllers
{
    ...
    public class WorkoutsController : BaseController
    {
        ...
        public async Task<IActionResult> GetAllWorkouts(CancellationToken cancellationToken)
        {
            ...
            var result = await _workoutsService.GetAllWorkoutsAsync(UserId, cancellationToken);
        ...
        [Authorize]
        [HttpGet("{id}")]
        public async Task<IActionResult> GetWorkoutById(string id, CancellationToken cancellationToken)
        {
            ...
            var result = await _workoutsService.GetWorkoutByIdAsync(id, UserId, cancellationToken);
        ...
        [Authorize]
        [HttpPost]
        public async Task<IActionResult> CreateWorkout([FromBody] CreateWorkoutRequest workoutRequest, CancellationToken cancellationToken)
        {
            ...
            var result = await _workoutsService.CreateWorkoutAsync(workoutRequest, UserId, cancellationToken);
        ...
        [Authorize]
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteWorkout(string id, CancellationToken cancellationToken)
        {
            if (string.IsNullOrWhiteSpace(id))
            {
            ...
            var result = await _workoutsService.DeleteWorkoutAsync(id, UserId, cancellationToken);
        ...
        public async Task<IActionResult> GetExercisesByWorkout(string workoutId, CancellationToken cancellationToken)
        {
            ...
            var result = await _workoutsService.GetExercisesInWorkoutAsync(workoutId, UserId, cancellationToken);
        ...
        public async Task<IActionResult> AddExerciseToWorkout([FromBody] CreateWorkoutExerciseRequest exercise, CancellationToken cancellationToken)
        {
            if (exercise == null || exercise.WorkoutId == null) return BadRequest();

            var result = await _workoutsService.AddExerciseToWorkoutAsync(exercise, UserId, cancellationToken);
        ...
        [Authorize]
        [HttpGet("{workoutId}/exercises/{exerciseId}")]
        public async Task<IActionResult> GetExerciseInWorkout(string workoutId, string workoutExerciseId, CancellationToken cancellationToken)
        {
            var userId = User.FindFirstValue(ClaimTypes.NameIdentifier);
            var exercise = await _workoutsService.GetWorkoutExerciseAsync(workoutId, workoutExerciseId, UserId, cancellationToken);
        ...
        public async Task<IActionResult> DeleteExerciseFromWorkout(string workoutId, string exerciseId, CancellationToken cancellationToken)
        {
            // try to get workout
            var result = await _workoutsService.RemoveExerciseFromWorkoutAsync(workoutId, exerciseId, UserId, cancellationToken);
